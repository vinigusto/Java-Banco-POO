package bancosistema.testes;

import bancosistema.entidades.*;
...
public class TestesManuais {
	public void executarTestes() {
		...
		Banco bancoDoBrasil = new Banco("com.bancosistema.model.Banco do Brasil");
		System.out.println("- Bancos criados: " + nubank.getNome() + " e " + bancoDoBrasil.getNome());

		System.out.println("\n2. Teste de criação de clientes:");
		Cliente cliente1 = new Cliente("Vinicius Augusto", "Rua Lorem, 123");
		Cliente cliente2 = new Cliente("Camila Ciscoto", "Av. Ipsum, 456");
		...
		System.out.println("\n4.1 Depósito:");
		contaVinicius.depositar(1000, false, true);
		System.out.print("CONTA: Vinicius ");
		contaVinicius.emitirSaldo();

		System.out.println("\n4.2 Retirada:");
		contaVinicius.retirada(300, false, true);
		System.out.print("CONTA: Vinicius ");
		contaVinicius.emitirSaldo();

		System.out.println("\n4.3 Tentativa de retirada com saldo insuficiente:");
		System.out.print("CONTA: Vinicius -> ");
		contaVinicius.retirada(6000, false,true);
		...
		contaCamila.transferencia(contaVinicius, 2000,true);
